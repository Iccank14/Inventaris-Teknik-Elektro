<?php
// Untuk lingkungan produksi, komentari dua baris berikut:
                    ...
                    <div class="row">
                        ...
                        <?php endif; ?>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <td class="info-label"><i class="fas fa-calendar"></i> Tanggal Perolehan</td>
                                ...
                                <?php endif; ?>
                                <!-- Kolom No SPK dan Jumlah Unit (revisi) -->
                                <tr>
                                    <td class="info-label"><i class="fas fa-file-contract"></i> No. SPK</td>
                                    <td>: <?= htmlspecialchars($aset['no_spk'] ?? '-') ?></td>
                                </tr>
                                <tr>
                                    <td class="info-label"><i class="fas fa-cubes"></i> Jumlah Unit</td>
                                    <td>: <?= (int)($aset['jumlah_unit'] ?? 1) ?> unit</td>
                                </tr>
                            </table>
