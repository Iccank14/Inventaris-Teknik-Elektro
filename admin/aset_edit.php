...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update database (termasuk no_spk dan jumlah_unit)
    ...
    $stmt->execute([
        ...
        $id_kategori, $id_lokasi, $kondisi,
        $harga_perolehan, $tgl_perolehan, $sumber_dana,
        $fotoPath, $keterangan, $no_spk, $jumlah_unit, $id
    ]);
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= htmlspecialchars($aset['kode_aset']) ?>" readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="harga_perolehan" class="form-control" 
                                   value="<?= $aset['harga_perolehan'] ?>" step="0.01" min="0">
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="jumlah_unit" class="form-control" 
                                   value="<?= $aset['jumlah_unit'] ?? 1 ?>" min="1" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="no_spk" class="form-control" 
                               value="<?= htmlspecialchars($aset['no_spk'] ?? '') ?>" placeholder="Contoh: SPK-001/2025">
                    </div>
