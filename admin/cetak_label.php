...
// Ambil semua aset
$asetList = $conn->query("SELECT a.*, k.nama_kategori FROM aset a LEFT JOIN kategori k ON a.id_kategori = k.id_kategori ORDER BY a.kode_aset")->fetchAll();
...
<div class="col-md-9 col-lg-10 p-4">
    ...
    <div class="alert alert-info">
        <i class="fas fa-info-circle"></i> Pilih aset yang ingin dicetak label QR-nya. Label akan dicetak dalam format yang siap dipotong.
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="cetak_label_proses.php" target="_blank">
                <div class="mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="checkbox" name="aset_ids[]" value="<?= $aset['id_aset'] ?>" class="aset-check">
                            </td>
                            ...
                            <td class="text-center">
                                <?php if(file_exists('../qrcodes/' . $aset['qr_code_string'] . '.png')): ?>
                                    <img src="<?= BASE_URL ?>/qrcodes/<?= $aset['qr_code_string'] ?>.png" width="50" height="50">
                                <?php else: ?>
