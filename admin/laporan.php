...
// Siapkan query dasar (digunakan untuk tampilan dan ekspor)
$query = "
...
if (isset($_GET['export']) && $_GET['export'] == 'excel') {
    ...
    foreach ($data as $row) {
        echo "<tr>";
        echo "<td>" . $no++ . "</td>";
        echo "<td>" . htmlspecialchars($row['kode_aset']) . "</td>";
        ...
        echo "<td>" . ($row['tgl_perolehan'] ? date('d/m/Y', strtotime($row['tgl_perolehan'])) : '-') . "</td>";
        echo "<td>" . $row['kondisi'] . "</td>";
        echo "<td>" . number_format($row['harga_perolehan'], 0, ',', '.') . "</td>";
        echo "</tr>";
    }
    echo "</table>";
    exit();
        ...
        <div class="card-body">
            <form method="GET" class="row">
                ...
                <div class="col-md-2 text-end">
                    <label>&nbsp;</label>
                    <div>
                        <!-- Tombol Export Excel saja, tanpa cetak -->
